...
<body>
    ...
    if (isset($_GET['tope'])) {
        $tope = intval($_GET['tope']); // Convertir a entero
    
        // Comprobar que 'tope' no sea negativo
        if ($tope >= 0) {
            ...
            if ($result->num_rows > 0) {
                ...
                echo '<p>No se encontraron productos con unidades menores o iguales a ' . $tope . ' y que no estén eliminados.</p>';
            }
